...
```
docs/team/{name}/weekly-update/{date-range}/data/outlook-summary.json
docs/team/{name}/weekly-update/{date-range}/data/outlook-events.json
```
...
**Base path:** `docs/team/{name}/weekly-update/{date-range}/`

Check that the folder exists. If not, **create the full structure** and give instructions:

1. Create `docs/team/{name}/weekly-update/{date-range}/data/`
2. Report:

> Created: `docs/team/{name}/weekly-update/{date-range}/data/`
>
> **Next steps:**
>
...
**Output file:** `docs/team/{name}/weekly-update/{date-range}/{date-range}-{YYYYMMDD}-{HHMM}-weekly-summary.md`

The timestamp is when the skill runs (now), not the week being reviewed.

Example: `docs/team/chris/weekly-update/20260315-21/20260315-21-20260327-1430-weekly-summary.md`
...
**Output file:** `docs/team/{name}/weekly-update/{date-range}/{date-range}-{YYYYMMDD}-{HHMM}-weekly-update.rtf`
